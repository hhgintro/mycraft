namespace Dreamteck.Splines.Editor
{
    ...
    public class DreamteckSplinesEditor : SplineEditor
    {
        ...
        public DreamteckSplinesEditor(SplineComputer splineComputer, SerializedObject splineHolder)
            : base (splineComputer.transform.localToWorldMatrix, splineHolder, "_spline")
        {
        ...
        public override void ApplyModifiedProperties(bool forceAllUpdate = false)
        {
            ...
            {
                spline.RebuildImmediate(true, forceAllUpdate);//@@2-2
			}
            GetPointsFromSpline();
        }
