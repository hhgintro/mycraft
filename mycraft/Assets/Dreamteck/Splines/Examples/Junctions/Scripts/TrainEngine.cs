namespace Dreamteck.Splines.Examples
{
    ...
    public class TrainEngine : MonoBehaviour
    {
        ...
        private void OnJunction(List<SplineTracer.NodeConnection> passed)
        {
            ...
            if (junctionSwitch.bridges.Count == 0) return; //The JunctionSwitch does not have bridge elements
            foreach (JunctionSwitch.Bridge bridge in junctionSwitch.bridges)
            {
                ...
                if (currentConnection == bridge.a)
                {
                    ...
                    Debug.Log($"bridge.a: current({currentConnection})");
                    return;
                }
                else
                {
                    ...
                    Debug.Log($"bridge.b: current({currentConnection})");
                    return;
                }
            }
        }
