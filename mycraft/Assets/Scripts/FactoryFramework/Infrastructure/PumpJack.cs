...
namespace FactoryFramework
{
    public class PumpJack : Building, IOutput
    {
        ...
        public override Mesh GetSharedMesh() { return this.transform.GetChild(0).GetChild(0).GetComponent<MeshFilter>().sharedMesh; }
		public override Material GetSharedMaterial() { return this.transform.GetChild(0).GetChild(0).GetComponent<MeshRenderer>().sharedMaterial; }
#else
