...
namespace FactoryFramework
{
    public class InputSocket : Socket
    {
        ...
        public override void Connect(Socket sock)
        {
            ...
            {
                //설치중인 conveyor의 자신과 충돌할때, 발생할 수 있다.
        ...
        public void HandleItemTransfer()
        {
            ...
            if (input.CanTakeInput(output.OutputType(outputConnection)) && output.CanGiveOutput(outputConnection))
            {
                // do the transfer
                input.TakeInput(output.GiveOutput(outputConnection));
            }
