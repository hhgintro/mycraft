...
namespace MyCraft
{
    public class BeltManager : BlockManager
    {
        ...
        protected override void Start()
        {
            ...
            BlockScript script = this.transform.Find("prefab/basic-transport-belt").GetComponent<BeltScript>();
            script.manager = this;
            this.prefabs.Add(script);
            script = this.transform.Find("prefab/prefab_belt_turn_left").GetComponent<BeltScript>();
            script.manager = this;
            this.prefabs.Add(script);
            script = this.transform.Find("prefab/prefab_belt_turn_right").GetComponent<BeltScript>();
            script.manager = this;
            this.prefabs.Add(script);
