...
namespace MyCraft
{
    public class IronManager : BlockManager
    {
        ...
        protected override void Start()
        {
            ...
            //this.prefabs_drill = new List<DrillScript>();
            //this.prefabs.Add(this.transform.Find("prefab/iron-ore").GetComponent<IronScript>());
            BlockScript script = this.transform.Find("prefab/iron-ore").GetComponent<IronScript>();
            script.manager = this;
