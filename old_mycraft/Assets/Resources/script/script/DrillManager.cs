...
namespace MyCraft
{
    public class DrillManager : BlockManager
    {
        ...
        protected override void Start()
        {
            ...
            //this.prefabs.Add(this.transform.Find("prefab/drill").GetComponent<DrillScript>());
            BlockScript script = this.transform.Find("prefab/drill").GetComponent<DrillScript>();
            script.manager = this;
